...
describe("FeedProxy Access controls", function () {
  beforeEach(async function () {
    ...
    const accessControllerArtifact: Artifact = await hre.artifacts.readArtifact("PairAccessController");
    this.accessController = <PairAccessController>await deployContract(this.signers.owner, accessControllerArtifact);
