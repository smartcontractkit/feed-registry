...
interface IFeedRegistry {
    event FeedAdded(address indexed asset, bytes32 indexed denomination, address indexed proxy);
    event FeedRemoved(address indexed asset, bytes32 indexed denomination, address indexed proxy);
